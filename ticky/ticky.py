...
descriptions = ['Created ticket', 'Failed to connect to DB', 'Service timeout', 'Bad input']
    ...
    for user in usernames:
        for msg in msg_type:
            for description in descriptions:
                ...
                logfile.write(f"{date} Ubuntu debian server ticky: {msg}: {description} [#{numbers}] ({user})\n")
